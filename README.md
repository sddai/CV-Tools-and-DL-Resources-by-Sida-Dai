# Computer Vision Tools & Deep Learning Resources
...
### 1. Copy files from list<br>
    [https://github.com/sddai/repo/blob/master/copy_file_from_list.py](https://github.com/sddai/repo/blob/master/copy_file_from_list.py)
